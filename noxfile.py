...
def _generate_pdf_docs(session: nox.Session) -> None:
    ...
    try:
        ...
        session.log("PDF documentation generated and available at: docs/build/latex/brave-search-python-client.pdf")
...
def docs(session: nox.Session) -> None:
    ...
    2. Dumps OpenAPI schemas (v1 and v2) in both YAML and JSON formats (if available)
