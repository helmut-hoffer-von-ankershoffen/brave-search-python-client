...
from brave_search_python_client.utils import get_logger
from brave_search_python_client.utils._log import _validate_file_name, logging_initialize
...
def test_get_logger_with_name() -> None:
    ...
    assert logger.name == "brave_search_python_client.test_module"


def test_get_logger_none() -> None:
    """Test get_logger with None name."""
    logger = get_logger(None)
    assert logger.name == "brave_search_python_client"


def test_get_logger_project_name() -> None:
    """Test get_logger with the project name."""
    logger = get_logger("brave_search_python_client")
    assert logger.name == "brave_search_python_client"
...
def test_logging_initialize_with_defaults() -> None:
    ...
    with (
        mock.patch("brave_search_python_client.utils._log.load_settings") as mock_load_settings,
