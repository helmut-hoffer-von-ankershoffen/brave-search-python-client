"""Tests to verify the CLI functionality of Brave Search Python Client works with Docker."""
...
def test_core_docker_cli_help_with_love(docker_services) -> None:
    ...
    out = docker_services._docker_compose.execute("run brave-search-python-client --help")
