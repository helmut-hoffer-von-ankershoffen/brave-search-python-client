...
2. Complete reference documentation [for the library](https://brave-search-python-client.readthedocs.io/en/latest/lib_reference.html), [for the CLI](https://brave-search-python-client.readthedocs.io/en/latest/cli_reference.html) and [for the API](https://brave-search-python-client.readthedocs.io/en/latest/api_reference_v1.html) on Read the Docs
...
[Show script code](https://github.com/helmut-hoffer-von-ankershoffen/brave-search-python-client/blob/main/examples/script.py) - [Read the reference documentation](https://brave-search-python-client.readthedocs.io/en/latest/lib_reference.html)
...
See the [reference documentation of the CLI](https://brave-search-python-client.readthedocs.io/en/latest/cli_reference.html) for detailed documentation of all CLI commands and options.
...
```shell
docker compose run --remove-orphans brave-search-python-client --help
docker compose run --remove-orphans brave-search-python-client hello-world
docker compose run --remove-orphans brave-search-python-client echo --help
docker compose run --remove-orphans brave-search-python-client echo "Lorem"
docker compose run --remove-orphans brave-search-python-client echo "Lorem" --json
docker compose run --remove-orphans brave-search-python-client openapi
docker compose run --remove-orphans brave-search-python-client openapi --output-format=json
...
* See the [reference documentation of the API](https://brave-search-python-client.readthedocs.io/en/latest/api_reference_v1.html) for detailed documentation of all API operations and parameters.
